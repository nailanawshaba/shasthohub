...
export type incomingCallMapType = {
  ...
  'keybase.1.provisionUi.chooseDevice'?: (
    params: {
      sessionID: int,
      devices: Array<provisionUi_Device>
    },
    response: {
      error: (err: string) => void,
...
export type provisionUi_GPGKey = {
  algorithm: string;
  keyID: string;
  creation: string;
  expiration: string;
...
export type provisionUi_GPGMethod = 0 /* 'GPG_NONE_0' */ | 1 /* 'GPG_IMPORT_1' */ | 2 /* 'GPG_SIGN_2' */

export type GPGMethod = 0 /* 'GPG_NONE_0' */ | 1 /* 'GPG_IMPORT_1' */ | 2 /* 'GPG_SIGN_2' */
...
// provisionUi.chooseGPGMethod ////////////////////////////////////////

export type provisionUi_chooseGPGMethod_result = provisionUi_GPGMethod
...
// provisionUi.chooseDevice ////////////////////////////////////////

export type provisionUi_chooseDevice_result = provisionUi_DeviceID
