...
class Usernames extends Component<void, Props, void> {
  ...
  render () {
    ...
    if (this.props.plainText) {
      return <Text type={this.props.type} backgroundMode={this.props.backgroundMode} style={{...containerStyle, ...this.props.containerStyle, ...this.props.style}} title={this.props.title} {...(this.props.inline ? inlineProps : { })}>{this.props.prefix}{rwers.map(u => u.username).join(this.props.plainDivider || ', ')}{this.props.suffix}</Text>
    }
