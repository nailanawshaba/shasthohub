...
// Action Creators
export const createAddPending = (payload: {|participants: Array<string>, temporary: boolean|}) => ({
  error: false,
  payload,
  type: addPending,
})
export const createAppendMessages = (payload: {|
...
export const createAttachmentLoaded = (payload: {|
  messageKey: Constants.MessageKey,
  path: ?string,
  isPreview: boolean,
|}) => ({error: false, payload, type: attachmentLoaded})
export const createAttachmentSaveFailed = (payload: {|messageKey: Constants.MessageKey|}) => ({
  error: false,
  payload,
  type: attachmentSaveFailed,
})
export const createAttachmentSaveStart = (payload: {|messageKey: Constants.MessageKey|}) => ({
  error: false,
  payload,
  type: attachmentSaveStart,
})
export const createAttachmentSaved = (payload: {|messageKey: Constants.MessageKey, path: ?string|}) => ({
  error: false,
  payload,
  type: attachmentSaved,
})
export const createBadgeAppForChat = (payload: {|conversations: Array<RPCTypes.BadgeConversationInfo>|}) => ({
  error: false,
  payload,
  type: badgeAppForChat,
})
...
export const createClearMessages = (payload: {|conversationIDKey: Constants.ConversationIDKey|}) => ({
  error: false,
  payload,
  type: clearMessages,
})
export const createClearRekey = (payload: {|conversationIDKey: Constants.ConversationIDKey|}) => ({
  error: false,
  payload,
  type: clearRekey,
})
export const createDeleteEntity = (payload: {|keyPath: Array<string>, ids: Iterable<string>|}) => ({
  error: false,
  payload,
  type: deleteEntity,
})
export const createDeleteMessage = (payload: {|message: Constants.Message|}) => ({
  error: false,
  payload,
  type: deleteMessage,
})
export const createDownloadProgress = (payload: {|
  messageKey: Constants.MessageKey,
  isPreview: boolean,
  progress: ?number,
|}) => ({error: false, payload, type: downloadProgress})
export const createEditMessage = (payload: {|message: Constants.Message, text: HiddenString|}) => ({
  error: false,
  payload,
  type: editMessage,
})
...
export const createGetInboxAndUnbox = (payload: {|
  conversationIDKeys: Array<Constants.ConversationIDKey>,
|}) => ({error: false, payload, type: getInboxAndUnbox})
...
export const createInboxSynced = (payload: {|convs: Array<ChatTypes.UnverifiedInboxUIItem>|}) => ({
  error: false,
  payload,
  type: inboxSynced,
})
export const createIncomingMessage = (payload: {|activity: ChatTypes.ChatActivity|}) => ({
  error: false,
  payload,
  type: incomingMessage,
})
export const createIncomingTyping = (payload: {|activity: ChatTypes.TyperInfo|}) => ({
  error: false,
  payload,
  type: incomingTyping,
})
export const createJoinConversation = (payload: {|conversationIDKey: Constants.ConversationIDKey|}) => ({
  error: false,
  payload,
  type: joinConversation,
})
export const createLeaveConversation = (payload: {|conversationIDKey: Constants.ConversationIDKey|}) => ({
  error: false,
  payload,
  type: leaveConversation,
})
export const createLoadAttachment = (payload: {|
  messageKey: Constants.MessageKey,
  loadPreview: boolean,
|}) => ({error: false, payload, type: loadAttachment})
export const createLoadAttachmentPreview = (payload: {|messageKey: Constants.MessageKey|}) => ({
  error: false,
  payload,
  type: loadAttachmentPreview,
})
export const createLoadInbox = () => ({error: false, payload: undefined, type: loadInbox})
export const createLoadMoreMessages = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
...
export const createLoadingMessages = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
  isRequesting: boolean,
|}) => ({error: false, payload, type: loadingMessages})
export const createMarkSeenMessage = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
  messageKey: Constants.MessageKey,
|}) => ({error: false, payload, type: markSeenMessage})
export const createMarkThreadsStale = (payload: {|updates: Array<ChatTypes.ConversationStaleUpdate>|}) => ({
  error: false,
  payload,
  type: markThreadsStale,
})
export const createMergeEntity = (payload: {|
...
export const createOpenAttachmentPopup = (payload: {|
  message: Constants.AttachmentMessage,
  currentPath: Path,
|}) => ({error: false, payload, type: openAttachmentPopup})
export const createOpenConversation = (payload: {|conversationIDKey: Constants.ConversationIDKey|}) => ({
  error: false,
  payload,
  type: openConversation,
})
export const createOpenFolder = () => ({error: false, payload: undefined, type: openFolder})
export const createOpenTeamConversation = (payload: {|
  teamname: TeamConstants.Teamname,
  channelname: string,
|}) => ({error: false, payload, type: openTeamConversation})
export const createOpenTlfInChat = (payload: {|tlf: string, isTeam?: boolean|}) => ({
  error: false,
  payload,
  type: openTlfInChat,
})
export const createOutboxMessageBecameReal = (payload: {|
  oldMessageKey: Constants.MessageKey,
  newMessageKey: Constants.MessageKey,
|}) => ({error: false, payload, type: outboxMessageBecameReal})
export const createPendingToRealConversation = (payload: {|
  oldKey: Constants.ConversationIDKey,
  newKey: Constants.ConversationIDKey,
|}) => ({error: false, payload, type: pendingToRealConversation})
export const createPostMessage = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
  text: HiddenString,
|}) => ({error: false, payload, type: postMessage})
export const createPrependMessages = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
  messages: Array<Constants.ServerMessage>,
  moreToLoad: boolean,
|}) => ({error: false, payload, type: prependMessages})
export const createRemoveOutboxMessage = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
  outboxID: Constants.OutboxIDKey,
|}) => ({error: false, payload, type: removeOutboxMessage})
export const createRemoveTempPendingConversations = () => ({
  error: false,
  payload: undefined,
  type: removeTempPendingConversations,
})
export const createReplaceEntity = (payload: {|
  keyPath: Array<string>,
  entities: I.Map<any, any> | I.List<any>,
|}) => ({error: false, payload, type: replaceEntity})
export const createRetryAttachment = (payload: {|message: Constants.AttachmentMessage|}) => ({
  error: false,
  payload,
  type: retryAttachment,
})
export const createRetryMessage = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
  outboxIDKey: string,
|}) => ({error: false, payload, type: retryMessage})
export const createSaveAttachment = (payload: {|messageKey: Constants.MessageKey|}) => ({
  error: false,
  payload,
  type: saveAttachment,
})
export const createSaveAttachmentNative = (payload: {|messageKey: Constants.MessageKey|}) => ({
  error: false,
  payload,
  type: saveAttachmentNative,
})
export const createSelectAttachment = (payload: {|input: Constants.AttachmentInput|}) => ({
  error: false,
  payload,
  type: selectAttachment,
})
export const createSelectConversation = (payload: {|
  conversationIDKey: ?Constants.ConversationIDKey,
  fromUser?: boolean,
|}) => ({error: false, payload, type: selectConversation})
export const createSelectNext = (payload: {|rows: Array<any>, direction: -1 | 1|}) => ({
  error: false,
  payload,
  type: selectNext,
})
export const createSetInboxFilter = (payload: {|filter: string|}) => ({
  error: false,
  payload,
  type: setInboxFilter,
})
export const createSetInboxGlobalUntrustedState = (payload: {|
  inboxGlobalUntrustedState: Constants.UntrustedState,
|}) => ({error: false, payload, type: setInboxGlobalUntrustedState})
export const createSetLoaded = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
  isLoaded: boolean,
|}) => ({error: false, payload, type: setLoaded})
export const createSetNotifications = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
  deviceType: DeviceType,
  notifyType: Constants.NotifyType,
|}) => ({error: false, payload, type: setNotifications})
export const createSetPreviousConversation = (payload: {|
  conversationIDKey: ?Constants.ConversationIDKey,
|}) => ({error: false, payload, type: setPreviousConversation})
export const createSetTypers = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
  typing: Array<string>,
...
export const createShareAttachment = (payload: {|messageKey: Constants.MessageKey|}) => ({
  error: false,
  payload,
  type: shareAttachment,
})
export const createShowEditor = (payload: {|message: ?Constants.Message|}) => ({
  error: false,
  payload,
  type: showEditor,
})
export const createStartConversation = (payload: {|
  users: Array<string>,
...
export const createThreadLoadedOffline = (payload: {|conversationIDKey: Constants.ConversationIDKey|}) => ({
  error: false,
  payload,
  type: threadLoadedOffline,
})
export const createToggleChannelWideNotifications = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
|}) => ({error: false, payload, type: toggleChannelWideNotifications})
export const createUnboxConversations = (payload: {|
  conversationIDKeys: Array<Constants.ConversationIDKey>,
  reason: string,
  force?: boolean,
...
export const createUpdateBrokenTracker = (payload: {|userToBroken: {[username: string]: boolean}|}) => ({
  error: false,
  payload,
  type: updateBrokenTracker,
})
export const createUpdateFinalizedState = (payload: {|finalizedState: Constants.FinalizedState|}) => ({
  error: false,
  payload,
  type: updateFinalizedState,
})
export const createUpdateInboxComplete = () => ({error: false, payload: undefined, type: updateInboxComplete})
export const createUpdateInboxRekeyOthers = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
  rekeyers: Array<string>,
|}) => ({error: false, payload, type: updateInboxRekeyOthers})
export const createUpdateInboxRekeySelf = (payload: {|conversationIDKey: Constants.ConversationIDKey|}) => ({
  error: false,
  payload,
  type: updateInboxRekeySelf,
})
...
export const createUpdateMetadata = (payload: {|users: Array<string>|}) => ({
  error: false,
  payload,
  type: updateMetadata,
})
export const createUpdateSnippet = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
  snippet: HiddenString,
|}) => ({error: false, payload, type: updateSnippet})
export const createUpdateSupersededByState = (payload: {|
  supersededByState: Constants.SupersededByState,
|}) => ({error: false, payload, type: updateSupersededByState})
export const createUpdateSupersedesState = (payload: {|supersedesState: Constants.SupersedesState|}) => ({
  error: false,
  payload,
  type: updateSupersedesState,
})
export const createUpdateTempMessage = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
...
export const createUpdateThread = (payload: {|
...
export const createUpdateTyping = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
  typing: boolean,
|}) => ({error: false, payload, type: updateTyping})
export const createUpdatedMetadata = (payload: {|updated: {[key: string]: Constants.MetaData}|}) => ({
  error: false,
  payload,
  type: updatedMetadata,
})
export const createUpdatedNotifications = (payload: {|
  conversationIDKey: Constants.ConversationIDKey,
  notifications: Constants.NotificationsState,
|}) => ({error: false, payload, type: updatedNotifications})
export const createUploadProgress = (payload: {|messageKey: Constants.MessageKey, progress: ?number|}) => ({
  error: false,
  payload,
  type: uploadProgress,
})
